...
(function () {
  ...
  function initThree() {
    ...
    // Geometric fragments (chaos elements)
    ...
    // Base platform
    const baseGeo = new THREE.CylinderGeometry(0.6, 0.7, 0.14, 48);
    ...
    // Small diamond / octahedron symbols (truth / clarity)
  ...
  function initScrollAnimations() {
    ...
    // Clarity word — the WOW moment
    const clarityWord = document.getElementById('clarity-word');
    const clarityStatement = document.querySelector('.clarity-statement');
