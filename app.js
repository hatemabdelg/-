(function () {
  ...
  /* ---------- Animated Scales (Hero only) ---------- */
  function initScales() {
    if (prefersReduced) return;
    const beam = document.getElementById("scales-beam");
    if (!beam || typeof gsap === "undefined") return;
    ...
    /* Fade scales out when leaving hero */
  ...
  function initAnimations() {
    ...
    heroTl
      .from(".hero-meta", { opacity: 0, y: 20, duration: 0.7 }, 0.2)
      .from(".hero-name .name-line", { opacity: 0, y: 55, duration: 0.95, stagger: 0.14 }, 0.3)
      .from(".hero-title", { opacity: 0, y: 24, duration: 0.7 }, 0.6)
      .from(".hero-tagline", { opacity: 0, y: 20, duration: 0.7 }, 0.75)
      .from(".hero-actions", { opacity: 0, y: 20, duration: 0.7 }, 0.9)
      .from(".hero-scales", { opacity: 0, x: -40, duration: 1.2 }, 0.4)
      .from(".hero-scroll-hint", { opacity: 0, duration: 0.8 }, 1.15);
